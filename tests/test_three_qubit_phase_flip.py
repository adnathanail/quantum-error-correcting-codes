...
from qecc.three_qubit_phase_flip import get_three_qubit_phase_flip_decoding_circuit
...
class TestThreeQubitPhaseFlipEncodingDecoding(QuantumCircuitTest):
    ...
    def test_encoding_0(self):
        ...
        self.encode(qc)
        self.check_results_n_results_even_chance(qc, ("000", "001", "010", "011", "100", "101", "110", "111"))
